...
const Skeletone = () => {
  return (
    <div
      ...
      <div className="flex items-center justify-center w-full md:w-1/3 h-40 bg-gray-300 rounded-sm dark:bg-gray-700">
        <svg
      ...
      <div className="md:w-2/3 w-full space-y-2.5">
        ...
        <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-10/12"></div>
        <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-9/12"></div>
        <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-8/12"></div>
      </div>
